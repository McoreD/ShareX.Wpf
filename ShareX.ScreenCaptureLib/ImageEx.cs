        ...
        public MemoryStream ExportAsMemoryStream()
        {
            ...
            foreach (var ann in Annotations)
            {
                if (ann.GetType() == typeof(Highlight))
                {
                    ...
                    dc.DrawRectangle(highlight.Brush, null, new Rect(highlight.TopLeft.X, highlight.TopLeft.Y, highlight.Width, highlight.Height));
                }
                else if (ann.GetType() == typeof(Obfuscate))
                {
                    Obfuscate obfuscate = ann as Obfuscate;
                    dc.DrawRectangle(obfuscate.Brush, null, new Rect(obfuscate.TopLeft.X, obfuscate.TopLeft.Y, obfuscate.Width, obfuscate.Height));
